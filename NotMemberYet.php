...
-->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Phone" name="updatephone" value="<?php echo $results['Phone'];?>"/>
                </div>
...
-->
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline"><input type="radio" name="updatenotification" value="notifyall" <?php if($results['Notification'] == 'notifyall'): ?> checked="checked" <?php endif; ?> >Notify All News</label>
                    <label class="radio-inline"><input type="radio" name="updatenotification" value="notifyfriend" <?php if($results['Notification'] == 'notifyfriend'): ?> checked="checked" <?php endif; ?>>Notify Friends' News Only</label>
